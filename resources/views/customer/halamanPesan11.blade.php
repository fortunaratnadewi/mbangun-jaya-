...
<head>
    ...
    <title>Cat Tembok Eksterior Harga Eceran</title>
    <style>
        .product-image {
            display: flex;
    ...
    <div class="product-container mx-auto p-4 max-w-5xl bg-white shadow-md">
        ...
        <div class="product-details flex flex-col md:flex-row gap-6">
            <div class="product-image flex flex-col items-center">
                <img id="mainImage" src="{{ asset('image/catC1.jpeg') }}" alt="Cat Tembok Eksterior" class="main-image mb-4">

                <!-- Thumbnail Buttons -->
                <div class="thumbnail-container">
                    <button class="thumbnail" onclick="changeImage('{{ asset('image/catC2.jpeg') }}')">
                        <img src="{{ asset('image/catC2.jpeg') }}" class="thumbnail-image" alt="gambar 1">
                    </button>
                    <button class="thumbnail" onclick="changeImage('{{ asset('image/catC2.jpeg') }}')">
                        <img src="{{ asset('image/catC3.jpeg') }}" class="thumbnail-image" alt="gambar 2">
                    </button>
                    <button class="thumbnail" onclick="changeImage('{{ asset('image/catC3.jpeg') }}')">
                        <img src="{{ asset('image/catC4.jpeg') }}" class="thumbnail-image" alt="gambar 3">
                    </button>
                </div>

            </div>
            <div class="product-info">
                <h1 class="text-2xl font-bold mb-2">Cat Tembok Eksterior Harga Eceran</h1>
        ...
        <div class="specifications mt-8 bg-gray-50 p-4 rounded-lg shadow-md">
            ...
            <div class="grid grid-cols-2 gap-4">
                <div><strong>Kategori:</strong> Cat dan Pelapis > Tembok Eksterior</div>
        ...
        <div class="description mt-4 bg-gray-50 p-4 rounded-lg shadow-md">
            ...
            <ul class="list-disc list-inside">
                <li>Cat tembok eksterior tahan lama dengan kualitas terbaik.</li>
        ...
        <div class="reviews mt-8 bg-gray-50 p-4 rounded-lg shadow-md">
            ...
            <div class="review-item p-4 bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300">
                ...
                <p class="text-sm text-gray-600 mt-2">Cat tembok eksterior ini benar-benar memberikan hasil akhir yang halus dan tahan lama.</p>

                <!-- Section for the uploaded image -->
                <div class="review-image-container flex space-x-4 mt-4">
                    <img src="image/catC2.jpeg" alt="Gambar Ulasan" class="w-32 h-32 object-cover rounded-lg">
                    <img src="image/catC5.jpeg" alt="Gambar Ulasan" class="w-32 h-32 object-cover rounded-lg">
                    
                    <!-- Extra images hidden by default -->
                    <div id="extraImages" class="hidden flex space-x-4">
                        <img src="image/catC1.jpeg" alt="Gambar Ulasan Tambahan" class="w-32 h-32 object-cover rounded-lg">
                        <img src="image/catC6.jpeg" alt="Gambar Ulasan Tambahan" class="w-32 h-32 object-cover rounded-lg">
                    </div>
