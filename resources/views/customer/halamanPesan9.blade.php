...
<head>
    ...
    <title>Cat Anti Gores Harga Eceran</title>
    <style>
        .product-image {
            display: flex;
    ...
    <div class="product-container mx-auto p-4 max-w-5xl bg-white shadow-md">
        ...
        <div class="product-details flex flex-col md:flex-row gap-6">
            <div class="product-image flex flex-col items-center">
                <img id="mainImage" src="{{ asset('image/catA1.webp') }}" alt="Cat Anti Gores" class="main-image mb-4">

                <!-- Thumbnail Buttons -->
                    <div class="thumbnail-container">
                        <button class="thumbnail" onclick="changeImage('{{ asset('image/catA1.webp') }}')">
                            <img src="{{ asset('image/catA2.jepg') }}" class="thumbnail-image" alt="gambar 1">
                        </button>
                        <button class="thumbnail" onclick="changeImage('{{ asset('image/catA2.jpeg') }}')">
                            <img src="{{ asset('image/catA3.jpeg') }}" class="thumbnail-image" alt="gambar 2">
                        </button>
                        <button class="thumbnail" onclick="changeImage('{{ asset('image/catA3.jpeg') }}')">
                            <img src="{{ asset('image/catA4.jpeg') }}" class="thumbnail-image" alt="gambar 3">
                        </button>
                    </div>

            </div>
            <div class="product-info">
                <h1 class="text-2xl font-bold mb-2">Cat Anti Gores Harga Eceran</h1>
        ...
        <div class="specifications mt-8 bg-gray-50 p-4 rounded-lg shadow-md">
            ...
            <div class="grid grid-cols-2 gap-4">
                <div><strong>Kategori:</strong> Cat dan Pelapis > Anti Gores</div>
        ...
        <div class="description mt-4 bg-gray-50 p-4 rounded-lg shadow-md">
            ...
            <ul class="list-disc list-inside">
                <li>Cat anti gores tahan lama dengan kualitas terbaik.</li>
                <li>Melindungi permukaan dari kerusakan dan memberikan hasil akhir yang halus.</li>
                <li>Tersedia dalam berbagai warna, cocok untuk interior maupun eksterior.</li>
        ...
        <div class="reviews mt-8 bg-gray-50 p-4 rounded-lg shadow-md">
            ...
            <div class="review-item p-4 bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300">
                ...
                <p class="text-sm text-gray-600 mt-2">Cat anti gores ini benar-benar memberikan hasil akhir yang halus dan tahan lama.</p>

                <!-- Section for the uploaded image -->
                <div class="review-image-container flex space-x-4 mt-4">
                    <img src="image/catA2.jpeg" alt="Gambar Ulasan" class="w-32 h-32 object-cover rounded-lg">
                    <img src="image/catA5.jpeg" alt="Gambar Ulasan" class="w-32 h-32 object-cover rounded-lg">
                    
                    <!-- Extra images hidden by default -->
                    <div id="extraImages" class="hidden flex space-x-4">
                        <img src="image/catA1.jpeg" alt="Gambar Ulasan Tambahan" class="w-32 h-32 object-cover rounded-lg">
                        <img src="image/catA6.jpeg" alt="Gambar Ulasan Tambahan" class="w-32 h-32 object-cover rounded-lg">
                    </div>
