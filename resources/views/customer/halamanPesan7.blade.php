...
<head>
    ...
    <title>Paku Serbaguna Harga Eceran</title>
    <style>
        .product-image {
            display: flex;
    ...
    <div class="product-container mx-auto p-4 max-w-5xl bg-white shadow-md">
        ...
        <div class="product-details flex flex-col md:flex-row gap-6">
            <div class="product-image flex flex-col items-center">
                <img id="mainImage" src="{{ asset('image/paku.jpeg') }}" alt="Paku Serbaguna" class="main-image mb-4">

                <!-- Thumbnail Buttons -->
                <div class="thumbnail-container">
                    <button class="thumbnail" onclick="changeImage('image/paku.jpeg')">
                        <img src="{{ asset('image/paku1.jpeg') }}" class="thumbnail-image" alt="gambar 1">
                    </button>
                    <button class="thumbnail" onclick="changeImage('image/paku1.jpeg')">
                        <img src="{{ asset('image/paku2.jpeg') }}" class="thumbnail-image" alt="gambar 2">
                    </button>
                    <button class="thumbnail" onclick="changeImage('image/paku2.jpeg')">
                        <img src="{{ asset('image/paku3.jpeg') }}" class="thumbnail-image" alt="gambar 3">
                    </button>
                </div>
            </div>
            <div class="product-info">
                <h1 class="text-2xl font-bold mb-2">Paku Serbaguna Harga Eceran</h1>
                <div class="rating flex items-center space-x-2 mb-2">
                    <span class="text-yellow-500">★★★★★</span>
                    <span class="text-gray-600">5.0 | 10 Penilaian</span>
                </div>
                <h2 class="text-xl font-bold text-red-600 mb-4">Rp. 10.000</h2>
        ...
        <div class="specifications mt-8 bg-gray-50 p-4 rounded-lg shadow-md">
            ...
            <div class="grid grid-cols-2 gap-4">
                ...
                <div><strong>Stok:</strong> 10.000</div>
                <div><strong>Merek:</strong> BEST NAIL</div>
                <div><strong>Kode Barang:</strong> pk2023</div>
            </div>
        </div>
        ...
        <div class="description mt-4 bg-gray-50 p-4 rounded-lg shadow-md">
            ...
            <ul class="list-disc list-inside">
                <li>Paku serbaguna dengan berbagai ukuran.</li>
                <li>Material berkualitas, tahan lama.</li>
                <li>Cocok untuk kebutuhan rumah tangga dan konstruksi ringan.</li>
        ...
        <div class="reviews mt-8 bg-gray-50 p-4 rounded-lg shadow-md">
            ...
            <div class="review-item p-4 bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300">
                ...
                <p class="text-sm text-gray-600 mt-2">Paku ini sangat kokoh dan berkualitas baik.</p>

                <!-- Section for the uploaded image -->
                <div class="review-image-container flex space-x-4 mt-4">
                    <img src="image/paku_review1.jpg" alt="Gambar Ulasan" class="w-32 h-32 object-cover rounded-lg">
                    <img src="image/paku_review2.webp" alt="Gambar Ulasan" class="w-32 h-32 object-cover rounded-lg">
                    
                    <!-- Extra images hidden by default -->
                    <div id="extraImages" class="hidden flex space-x-4">
                        <img src="image/paku_review3.jpg" alt="Gambar Ulasan Tambahan" class="w-32 h-32 object-cover rounded-lg">
                        <img src="image/paku_review4.jpg" alt="Gambar Ulasan Tambahan" class="w-32 h-32 object-cover rounded-lg">
                    </div>
