...
<head>
    ...
    <title>VETTO Stop Kontak V8202 / TK SNI</title>
    <style>
        .product-image {
            display: flex;
    ...
    <div class="product-container mx-auto p-4 max-w-5xl bg-white shadow-md">
        ...
        <div class="product-details flex flex-col md:flex-row gap-6">
            <div class="product-image flex flex-col items-center">
                <img id="mainImage" src="{{ asset('image/stopkontak1.webp') }}" alt="Stopkontak" class="main-image mb-4">

                <!-- Thumbnail Buttons -->
                <div class="thumbnail-container">
                    <button class="thumbnail" onclick="changeImage('{{ asset('image/stopkontak1.webp') }}')">
                        <img src="{{ asset('image/stopkontak1.webp') }}" class="thumbnail-image" alt="gambar 1">
                    </button>
                    <button class="thumbnail" onclick="changeImage('{{ asset('image/stopkontak2.webp') }}')">
                        <img src="{{ asset('image/stopkontak2.webp') }}" class="thumbnail-image" alt="gambar 2">
                    </button>
                    <button class="thumbnail" onclick="changeImage('{{ asset('image/stopkontak3.webp') }}')">
                        <img src="{{ asset('image/stopkontak3.webp') }}" class="thumbnail-image" alt="gambar 3">
                    </button>
                </div>

            </div>
            <div class="product-info">
                <h1 class="text-2xl font-bold mb-2">VETTO Stop Kontak V8202 / TK SNI</h1>
        ...
        <div class="specifications mt-8 bg-gray-50 p-4 rounded-lg shadow-md">
            ...
            <div class="grid grid-cols-2 gap-4">
                <div><strong>Kategori:</strong> Stopkontak</div>
                <div><strong>Stok:</strong> 3.500</div>
                <div><strong>Merek:</strong> BestElectro</div>
                <div><strong>Kode Barang:</strong> STOP2023</div>
            </div>
        </div>
        ...
        <div class="description mt-4 bg-gray-50 p-4 rounded-lg shadow-md">
            ...
            <ul class="list-disc list-inside">
                <li>Stopkontak berkualitas tinggi dengan desain ergonomis.</li>
                <li>Cocok untuk penggunaan di rumah maupun kantor.</li>
                <li>Memiliki beberapa port untuk kebutuhan charging.</li>
        ...
        <div class="reviews mt-8 bg-gray-50 p-4 rounded-lg shadow-md">
            ...
            <div class="review-item p-4 bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300">
                ...
                <p class="text-sm text-gray-600 mt-2">Stopkontak ini sangat praktis dan efisien untuk penggunaan sehari-hari.</p>

                <!-- Section for the uploaded image -->
                <div class="review-image-container flex space-x-4 mt-4">
                    <img src="image/stopkontak2.webp" alt="Gambar Ulasan" class="w-32 h-32 object-cover rounded-lg">
                    <img src="image/stopkontak5.webp" alt="Gambar Ulasan" class="w-32 h-32 object-cover rounded-lg">
                    
                    <!-- Extra images hidden by default -->
                    <div id="extraImages" class="hidden flex space-x-4">
                        <img src="image/stopkontak1.webp" alt="Gambar Ulasan Tambahan" class="w-32 h-32 object-cover rounded-lg">
                        <img src="image/stopkontak6.webp" alt="Gambar Ulasan Tambahan" class="w-32 h-32 object-cover rounded-lg">
                    </div>
