...
<head>
    ...
    <title>Besi Beton 12mm Harga Eceran</title>
    <style>
        .product-image {
            display: flex;
    ...
    <div class="product-container mx-auto p-4 max-w-5xl bg-white shadow-md">
        ...
        <div class="product-details flex flex-col md:flex-row gap-6">
            <div class="product-image flex flex-col items-center">
                <img id="mainImage" src="{{ asset('image/besi.jpeg') }}" alt="Besi Beton 12mm" class="main-image mb-4">

                <!-- Thumbnail Buttons -->
                <div class="thumbnail-container">
                    <button class="thumbnail" onclick="changeImage('image/besi.jpeg')">
                        <img src="{{ asset('image/besi.jpeg') }}" class="thumbnail-image" alt="gambar 1">
                    </button>
                    <button class="thumbnail" onclick="changeImage('image/besi1.jpeg')">
                        <img src="{{ asset('image/besi3.webp') }}" class="thumbnail-image" alt="gambar 2">
                    </button>
                    <button class="thumbnail" onclick="changeImage('image/besi2.jpeg')">
                        <img src="{{ asset('image/besi2.jpeg') }}" class="thumbnail-image" alt="gambar 3">
                    </button>
                </div>
            </div>
            <div class="product-info">
                <h1 class="text-2xl font-bold mb-2">Besi Beton 12mm Harga Eceran</h1>
                <div class="rating flex items-center space-x-2 mb-2">
                    <span class="text-yellow-500">★★★★★</span>
                    <span class="text-gray-600">5.0 | 15 Penilaian</span>
                </div>
                <h2 class="text-xl font-bold text-red-600 mb-4">Rp. 70.000</h2>
        ...
        <div class="specifications mt-8 bg-gray-50 p-4 rounded-lg shadow-md">
            ...
            <strong>Kategori:</strong> Mbangun Jaya > 
                ...
                <div><strong>Stok:</strong> 8.456</div>
                <div><strong>Merek:</strong> SuperSteel</div>
                <div><strong>Kode Barang:</strong> b45hty</div>
            </div>
        </div>
        ...
        <div class="description mt-4 bg-gray-50 p-4 rounded-lg shadow-md">
            ...
            <ul class="list-disc list-inside">
                <li>Besi Beton 12mm berkualitas tinggi.</li>
                <li>Tahan terhadap beban berat dan tahan lama.</li>
                <li>Minimal pembelian 50 batang.</li>
        ...
        <div class="reviews mt-8 bg-gray-50 p-4 rounded-lg shadow-md">
            ...
            <div class="flex items-center space-x-2 mb-4">
                <span class="text-yellow-500">★★★★★</span>
                <span class="text-gray-600">5 dari 5 | 85 Ulasan</span>
            </div>
            <div class="review-item p-4 bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300">
                <div class="flex items-center space-x-2">
                    ...
                    <div>
                        <p class="font-bold">Adit P.</p>
                        <span class="text-yellow-500">★★★★★</span>
                        <span class="text-gray-500">Besi Berkualitas</span>
                    </div>
                </div>
                <p class="text-sm text-gray-600 mt-2">Produk sangat kokoh dan sesuai dengan deskripsi. Pengiriman cepat dan terjamin.</p>
                
                <!-- Section for the uploaded image -->
                <div class="review-image-container flex space-x-4 mt-4">
                    <img src="image/besi1.jpg" alt="Gambar Ulasan" class="w-32 h-32 object-cover rounded-lg">
                    <img src="image/besi4.jpg" alt="Gambar Ulasan" class="w-32 h-32 object-cover rounded-lg">
                    
                    <!-- Extra images hidden by default -->
                    <div id="extraImages" class="hidden flex space-x-4">
                        <img src="image/besi1.jpg" alt="Gambar Ulasan Tambahan" class="w-32 h-32 object-cover rounded-lg">
                        <img src="image/besi4.jpg" alt="Gambar Ulasan Tambahan" class="w-32 h-32 object-cover rounded-lg">
                    </div>
