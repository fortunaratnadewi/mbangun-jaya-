...
<head>
    ...
    <title>Obeng Multifungsi Harga Eceran</title>
    <style>
        .product-image {
            display: flex;
    ...
    <div class="product-container mx-auto p-4 max-w-5xl bg-white shadow-md">
        ...
        <div class="product-details flex flex-col md:flex-row gap-6">
            <div class="product-image flex flex-col items-center">
                <img id="mainImage" src="{{ asset('image/obeng.png') }}" alt="Obeng Multifungsi" class="main-image mb-4">

                <!-- Thumbnail Buttons -->
                <div class="thumbnail-container">
                    <button class="thumbnail" onclick="changeImage('image/obeng1.jpeg')">
                        <img src="{{ asset('image/obeng1.jpeg') }}" class="thumbnail-image" alt="gambar 1">
                    </button>
                    <button class="thumbnail" onclick="changeImage('image/obeng2.jpeg')">
                        <img src="{{ asset('image/obeng2.jpeg') }}" class="thumbnail-image" alt="gambar 2">
                    </button>
                    <button class="thumbnail" onclick="changeImage('image/obeng3.jpeg')">
                        <img src="{{ asset('image/obeng3.jpeg') }}" class="thumbnail-image" alt="gambar 3">
                    </button>
                </div>
            </div>
            <div class="product-info">
                <h1 class="text-2xl font-bold mb-2">Obeng Multifungsi Harga Eceran</h1>
                <div class="rating flex items-center space-x-2 mb-2">
                    <span class="text-yellow-500">★★★★★</span>
                    <span class="text-gray-600">5.0 | 10 Penilaian</span>
                </div>
                <h2 class="text-xl font-bold text-red-600 mb-4">Rp. 25.000</h2>
        ...
        <div class="specifications mt-8 bg-gray-50 p-4 rounded-lg shadow-md">
            ...
            <div class="grid grid-cols-2 gap-4">
                <div><strong>Kategori:</strong> Mbangun Jaya > Alat Pertukangan</div>
                <div><strong>Stok:</strong> 8.000</div>
                <div><strong>Merek:</strong> BEST TOOL</div>
                <div><strong>Kode Barang:</strong> obg2023</div>
            </div>
        </div>
        ...
        <div class="description mt-4 bg-gray-50 p-4 rounded-lg shadow-md">
            ...
            <ul class="list-disc list-inside">
                <li>Obeng Multifungsi dengan berbagai kepala obeng.</li>
                <li>Material kokoh dan tahan lama.</li>
                <li>Pemakaian untuk berbagai keperluan rumah tangga.</li>
        ...
        <div class="reviews mt-8 bg-gray-50 p-4 rounded-lg shadow-md">
            ...
            <div class="review-item p-4 bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300">
                <div class="flex items-center space-x-2">
                    <img src="image/user.jpg" alt="User" class="w-10 h-10 rounded-full">
                    <div>
                ...
                <p class="text-sm text-gray-600 mt-2">Obeng ini sangat praktis dan berkualitas baik.</p>

                <!-- Section for the uploaded image -->
                <div class="review-image-container flex space-x-4 mt-4">
                    <img src="image/obeng_review1.jpg" alt="Gambar Ulasan" class="w-32 h-32 object-cover rounded-lg">
                    <img src="image/obeng_review2.webp" alt="Gambar Ulasan" class="w-32 h-32 object-cover rounded-lg">
                    
                    <!-- Extra images hidden by default -->
                    <div id="extraImages" class="hidden flex space-x-4">
                        <img src="image/obeng_review3.jpg" alt="Gambar Ulasan Tambahan" class="w-32 h-32 object-cover rounded-lg">
                        <img src="image/obeng_review4.jpg" alt="Gambar Ulasan Tambahan" class="w-32 h-32 object-cover rounded-lg">
                    </div>
